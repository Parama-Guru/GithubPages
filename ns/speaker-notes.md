...
Left / Right arrows or Page Up / Page Down navigate slides, including while speaker notes are open. Tab opens speaker notes from the presentation; Escape closes them. Press / or the keyboard icon for the shortcut guide. Inside dialogs and form controls, Tab moves focus normally; Shift+Tab always moves backward. The guide includes an option to restore normal Tab navigation everywhere. Home / End jump to the first / last slide. Space plays or pauses the twelve-second explainer. N opens speaker notes; O opens the overview. The talk timer starts separately and does not advance slides.
